...
Since 1.2.1.0
- ability to show the characters in a grid                                 (p/s)
- display the character code of the actual selected character              (p/s)
- jump to an character (120, 0x78, 78h)                                    (p/s)
- change the whole font in width/height to the current character           (p/s)
